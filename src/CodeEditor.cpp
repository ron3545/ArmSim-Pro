...
static ArmSimPro::TextEditor* txt_editor = nullptr;
//=============================================================================================
...
//==============================================Setting up Code Editor======================================================================================
    txt_editor = new ArmSimPro::TextEditor();
    ...
    while (!done)
    {
        ...
        {   
            ...
            //Code Editor dockable panel
            {
                ...
                ImGui::PushStyleVar(ImGuiStyleVar_FramePadding, ImVec2(-1.0f, 10)); //used to change window titlebar height;
